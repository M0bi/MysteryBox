package me.mobi.mysterybox.api.particle;
...
public enum ParticleEffect {
    ...
    /**
     * A particle effect which is displayed by primed tnt, torches, droppers, dispensers, end portals,
    ...
    /**
     * A particle effect which is displayed by nether portals, endermen, ender pearls,
     * eyes of ender, ender chests and dragon eggs:
     * <ul>
    ...
    /**
     * Displays a particle effect which is only visible for all players
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center,
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ,
                speed, amount, range > 256, null).sendTo(center, range);
    }
    ...
    public void display(float offsetX, float offsetY, float offsetZ, float speed, int amount, Location center,
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ, speed,
                amount, isLongDistance(center, players), null).sendTo(center, players);
    }
     ...
     * @throws ParticleVersionException If the particle effect is not supported by the server version
     * @throws ParticleDataException If the particle effect requires additional data
     * @throws IllegalArgumentException If the particle effect is not directional
     * or if it requires water and none is at the center location
     */
    ...
    /**
     * Displays a single particle which flies into a determined
    ...
    public void display(Vector direction, float speed, Location center, List<Player> players)
        ...
        new ParticlePacket(this, direction, speed,
                isLongDistance(center, players), null).sendTo(center, players);
    }

    /**
     * Displays a single particle which flies into a determined direction
     * and is only visible for the specified players
     *
     * @param direction Direction of the particle
     * @param speed Display speed of the particle
     * @param center Center location of the effect
     ...
     * @see ParticlePacket#sendTo(Location, double)
     */
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ,
        ...
        new ParticlePacket(this, offsetX, offsetY, offsetZ,
                speed, amount, range > 256, data).sendTo(center, range);
    }
    ...
    public void display(ParticleData data, float offsetX, float offsetY, float offsetZ, float speed,
                        int amount, Location center, List<Player> players)
            throws ParticleVersionException, ParticleDataException {
        if (!isSupported()) {
            throw new ParticleVersionException("This particle effect isn't supported by your server version");
        }
     ...
     * @param players Receivers of the effect
     * @throws ParticleVersionException If the particle effect is not supported by the server version
     * @throws ParticleDataException If the particle effect does
     * not require additional data or if the data type is incorrect
    ...
    /**
     * Displays a single particle which requires additional data that flies into a determined direction and
     * is only visible for all players within a certain range in the world of @param center
     *
     * @param data Data of the effect
     * @param direction Direction of the particle
     * @param speed Display speed of the particles
     ...
     * @param players Receivers of the effect
     * @throws ParticleVersionException If the particle effect is not supported by the server version
     * @throws ParticleDataException If the particle effect does not require additional
     * data or if the data type is incorrect
    ...
    /**
     * Represents a runtime exception that is thrown either if the displayed particle effect requires data
     * and has none or vice-versa or if the data type is incorrect
     * <p>
     * This class is part of the <b>ParticleEffect Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
    ...
    public static final class ParticlePacket {
        ...
        public ParticlePacket(ParticleEffect effect, float offsetX, float offsetY, float offsetZ, float speed,
                              int amount, boolean longDistance, ParticleData data)
         ...
         */
        public ParticlePacket(ParticleEffect effect, org.bukkit.util.Vector direction,float speed, boolean longDistance,
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                version = Integer.parseInt(Character.toString(ReflectionUtils.PackageType.
                        getServerVersion().charAt(3)));
                if (version > 7) {
                    enumParticle = ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass("EnumParticle");
                }
                Class<?> packetClass =
                        ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass(version < 7
                                ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");
                ...
                throw new VersionIncompatibleException("Your current bukkit version seems to be "
                        + "incompatible with this library", exception);
            }
            initialized = true;
        }
        ...
        /**
         * Determine if
         * {@link #packetConstructor}, {@link #getHandle}, {@link #playerConnection} and
            ...
            try {
                ...
                if (version < 8) {
                    ...
                    if (data != null) {
                        ...
                        ReflectionUtils.setValue(packet, true, "k", effect == ParticleEffect.ITEM_CRACK
